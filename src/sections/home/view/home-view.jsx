...
export function HomeView({ mdContent, frontMatter }) {
  ...
  return (
    <>
      ...
      <HomeHero mdContent={mdContent} frontMatter={frontMatter} />
      {/* Home page lower section */}
      <Stack sx={{ m: 3, position: 'relative', bgcolor: 'background.default' }}>
        <HomeContent mdContent={mdContent} frontMatter={frontMatter} />
      </Stack>
