...
subtitle: Référence à certains de mes projets les plus intéressants
tiles:
  # ---------------------------------------------------------------
  ...
  - title: Cadre de Site Web Multilingue
    eyebrow: Développement Web
    description: Démarrage React et Markdown qui traduit automatiquement le contenu avec le support LLM
