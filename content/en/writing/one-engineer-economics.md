...
That is what the solo-founder number is really measuring. The floor under a functioning product team dropped.
...
So the defensible version of the thesis is narrower than the headline, and more useful. One-engineer economics is real, and it arrives at the edges first: a solo founder, an internal tool, a spike, a migration nobody had budget for. It arrives inside a large organisation on the day the platform is good enough that one person can get from idea to production without asking six teams for permission.
...
→ Related: [Working across an organisation](/en/expertise/stakeholder-alignment) and [AI & automation](/en/expertise/ai-and-automation).
