...
export const customConfig = {
  ...
  settings: {
    ...
    // Treat specific external packages as core modules so eslint-plugin-import
    // doesn't attempt to resolve their internals (useful for private packages
    // without proper "exports" fields that break resolution during CI builds).
    'import/core-modules': ['@fps4/widget-ui'],
  },
  rules: {
    ...commonRules(),
    ...importRules(),
